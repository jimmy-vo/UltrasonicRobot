...
#include "ICONVIEW.h"
#include "TEXT.h"
#if 1//(SHOW_GUIDEMO_ICONVIEW && GUI_WINSUPPORT && GUI_SUPPORT_MEMDEV)
...
//  pcbPrev = WM_SetCallback(WM_HBKWIN, _cbWin);
  ...
  //
  hText0 = TEXT_CreateEx(0, 0, 320, 30, WM_HBKWIN, WM_CF_SHOW, 0, GUI_ID_TEXT0, "emWin ICONVIEW sample");
  TEXT_SetFont(hText0, &GUI_Font24B_ASCII);
